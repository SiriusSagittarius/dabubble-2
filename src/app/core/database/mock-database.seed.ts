      ...
      profileCategories: [
        {
          ...
          entries: [
            { value: 'TypeScript', emoji: '⚙️' },
            { value: 'Angular', emoji: '🅰️' },
            { value: 'Firebase', emoji: '🔥' },
        ...
        },
        {
          ...
          entries: [
            { value: 'GitHub: frederik-beck', emoji: '🐙' },
            { value: 'Twitter: @frederikcbeck', emoji: '𝕏' },
            { value: 'LinkedIn: freddybeck', emoji: '💼' },
          ],
        },
      ],
    },
