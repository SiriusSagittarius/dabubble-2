...
export class ModalsContainer {
  ...
  protected closeAddChannelDialog(): void {
    ...
    // Dialog-Status zuruecksetzen, damit das naechste Oeffnen wieder mit
    // Schritt 1 (Namenseingabe) startet - auch wenn die Sidebar den Dialog
    // direkt ueber den UiState oeffnet.
    this.addChannelMembersStep = false;
    this.addChannelNameDraft = '';
    this.addChannelDescriptionDraft = '';
    this.addChannelIsPrivate = false;
